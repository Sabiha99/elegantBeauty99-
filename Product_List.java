...
public class Product_List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = database.getReference("Foundation");
        ...
        if(Common.isConnectedToInternet(this)) {
            ...
            Toast.makeText(Product_List.this, "Please check your internet connection!", Toast.LENGTH_SHORT).show();
            return;
        }
        loadSuggest();
            ...
            protected void onBindViewHolder(@NonNull @NotNull FoundationViewHolder holder, int position, @NonNull @NotNull Foundation model){
                ...
                holder.setOnItemClick(new OnItemClick() {
                    ...
                    public void OnClick(View view, int pos, boolean isLongClick) {
                        Intent productDetail= new Intent(Product_List.this,Product_detail.class);
               ...
               holder.img_fav.setOnClickListener(new View.OnClickListener() {
                   ...
                   public void onClick(View v) {
                       ...
                       if(!localDB.ifFavourite(adapter.getRef(pos).getKey(),Common.currentUser.getPhone()))
                       {
                           ...
                           holder.img_fav.setImageResource(R.drawable.ic_baseline_favorite_24);
                           Toast.makeText(Product_List.this, "Added to Favourites", Toast.LENGTH_SHORT).show();
                       }
                       else
                       {
                           ...
                           Toast.makeText(Product_List.this, "Removed from Favourites", Toast.LENGTH_SHORT).show();
                       }
                   }
               });
                final Foundation clickItem = model;
