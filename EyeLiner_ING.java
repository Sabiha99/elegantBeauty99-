...
public class EyeLiner_ING extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = database.getReference("EyeING");
        ...
        if(Common.isConnectedToInternet(this)) {
            ...
            Toast.makeText(EyeLiner_ING.this, "Please check your internet connection!", Toast.LENGTH_SHORT).show();
            return;
        }
        loadSuggest();
            ...
            protected void onBindViewHolder(@NonNull @NotNull FoundationViewHolder holder, int position, @NonNull @NotNull Foundation model){
                ...
                holder.setOnItemClick(new OnItemClick() {
                    ...
                    public void OnClick(View view, int pos, boolean isLongClick) {
                        Intent productDetail= new Intent(EyeLiner_ING.this,EyeLinerING_details.class);
...
public void onClick(View v) {
    ...
    Favourites favourites=new Favourites();
        ...
        holder.img_fav.setImageResource(R.drawable.ic_baseline_favorite_24);
        Toast.makeText(EyeLiner_ING.this, "Added to Favourites", Toast.LENGTH_SHORT).show();
        }
        else
        {
        ...
        Toast.makeText(EyeLiner_ING.this, "Removed from Favourites", Toast.LENGTH_SHORT).show();
        }
        }
        });
final Foundation clickItem = model;
