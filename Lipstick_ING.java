...
public class Lipstick_ING extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = database.getReference("LipING");
        ...
        if (Common.isConnectedToInternet(this)) {
            ...
            Toast.makeText(Lipstick_ING.this, "Please check your internet connection!", Toast.LENGTH_SHORT).show();
            return;
        }
        loadSuggest();
    ...
    private void startSearch(CharSequence text) {
        ...
        searchAdapter = new FirebaseRecyclerAdapter<Foundation, FoundationViewHolder>(options) {
            ...
            @NotNull
            @Override
            public FoundationViewHolder onCreateViewHolder(@androidx.annotation.NonNull @NotNull ViewGroup parent, int viewType) {
            ...
            @Override
            protected void onBindViewHolder(@androidx.annotation.NonNull @NotNull FoundationViewHolder holder, int position, @androidx.annotation.NonNull @NotNull Foundation model) {
                ...
                holder.setOnItemClick(new OnItemClick() {
                    ...
                    public void OnClick(View view, int pos, boolean isLongClick) {
                        Intent productDetail = new Intent(Lipstick_ING.this, LipstickING_detail.class);
                ...
                holder.img_fav.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!localDB.ifFavourite(adapter.getRef(pos).getKey(), Common.currentUser.getPhone())) {
                            ...
                            holder.img_fav.setImageResource(R.drawable.ic_baseline_favorite_24);
                            Toast.makeText(Lipstick_ING.this, "Added to Favourites", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            Toast.makeText(Lipstick_ING.this, "Removed from Favourites", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                final Foundation clickItem = model;
