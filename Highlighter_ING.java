...
public class Highlighter_ING extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = database.getReference("HighlighterING");
        ...
        if(Common.isConnectedToInternet(this)) {
            ...
            Toast.makeText(Highlighter_ING.this, "Please check your internet connection!", Toast.LENGTH_SHORT).show();
            return;
        }
        loadSuggest();
            ...
            protected void onBindViewHolder(@NonNull @NotNull FoundationViewHolder holder, int position, @NonNull @NotNull Foundation model){
                ...
                holder.setOnItemClick(new OnItemClick() {
                    ...
                    public void OnClick(View view, int pos, boolean isLongClick) {
                        Intent productDetail= new Intent(Highlighter_ING.this,HighlighterING_detail.class);
...
public void onClick(View v) {
        ...
        holder.img_fav.setImageResource(R.drawable.ic_baseline_favorite_24);
        Toast.makeText(Highlighter_ING.this, "Added to Favourites", Toast.LENGTH_SHORT).show();
        }
        else
        {
        ...
        Toast.makeText(Highlighter_ING.this, "Removed from Favourites", Toast.LENGTH_SHORT).show();
        }
        }
        });
final Foundation clickItem = model;
